...
DROPIN_FILE="${DROPIN_DIR}/vision-rknn-dryrun.conf"
BOARD_DIR="${BOARD_DIR:-/home/linaro/edgeinfer-rk3588-board}"

echo "=== Enable EdgeInfer Vision RKNN dryrun backend ==="
...
[Service]
Environment=EDGEINFER_VISION_BACKEND_MODE=rknn-yolo-dryrun
Environment=EDGEINFER_RKNN_YOLO_PYTHON=/usr/bin/python3
Environment=EDGEINFER_RKNN_YOLO_PROBE_TIMEOUT_SECONDS=60
EOF
