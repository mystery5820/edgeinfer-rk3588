...
DROPIN_FILE="${DROPIN_DIR}/vision-rknn-detect-probe.conf"
...
echo "=== Enable EdgeInfer Vision RKNN detect probe backend ==="
...
[Service]
Environment=EDGEINFER_VISION_BACKEND_MODE=rknn-yolo-detect-probe
